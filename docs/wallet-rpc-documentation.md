...
This is a list of the exohood-wallet-rpc calls, their Inputs and Outputs, and examples of each.
```
...
If the exohood-wallet-rpc was executed with the  `--rpc-login`  argument as  `username:password` , then follow this example:
...
Note: "Atomic Units" refer to the smallest fraction of 1 exo according to the exohoodd implementation.  **1 exo = 100 Atomic Units.**
...
* *balance*  - unsigned int; The total balance of the current exohood-wallet-rpc in session.
* *unlocked_balance*  - unsigned int; Unlocked funds are those funds that are sufficiently deep enough in the exohood blockchain to be considered safe to spend.
...
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_balance","params":{"account_index":0,"address_indices":[0,1]}}' -H 'Content-Type: application/json'
{
  ...
  "result": {
    ...
    "per_subaddress": [{
      "address": "exokKzqmNPQMk7DehZMif4FLJa1hpUQXjH6ULFEmyVUkRfJfrbphCZsCQt8G2dq1hbC2h4QsDMeohMrUeHcTmtSF4uG2NL756Z",
      "address_index": 0,
      "balance": 100000,
      "blocks_to_unlock": 4,
      ...
      "address": "exokufaYsjMEraaDRD37pSiNYsCzodhabEAmMjDGhcNTD41wZHZnMx8KK4hbTQ1Gv6N558r7DFTJShYQUMPmRkab1ZraHdTczk",
      "address_index": 1,
      "balance": 200000,
      "blocks_to_unlock": 4,
      "label": "",
...
* *address*  - string; The 95-character hex address string of the exohood-wallet-rpc in session.
...
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_address","params":{"account_index":0,"address_index":[0,1,4]}}' -H 'Content-Type: application/json'
{
  ...
  "jsonrpc": "2.0",
  "result": {
    "address": "exok4YGjvutPsJvihejok8h63PadX47sgYmVttR9aCdbNeDgKWemFkzcaVHJYyZTnh8Po4UMwQmYp4HVGss7zyiQ3PEC7VVkc7",
    "addresses": [{
      "address": "exok4YGjvutPsJvihejok8h63PadX47sgYmVttR9aCdbNeDgKWemFkzcaVHJYyZTnh8Po4UMwQmYp4HVGss7zyiQ3PEC7VVkc7",
      "address_index": 0,
      "label": "Primary account",
      ...
      "address": "exokjHMY5Cmbjmjuw8eEeXK41sJn7JS8Wfr4Px1SwVEXLMU8Zzafmm7QmFcCbsWgcaLqT7jQ7vF2zFnBgXQGpU1V4qGEsTE9T4",
      "address_index": 1,
      "label": "",
      "used": true
    },{
      "address": "exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY",
      "address_index": 4,
      "label": "test2",
      "used": true
    }]
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_address_index","params":{"address":"exokufaYsjMEraaDRD37pSiNYsCzodhabEAmMjDGhcNTD41wZHZnMx8KK4hbTQ1Gv6N558r7DFTJShYQUMPmRkab1ZraHdTczk"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
$ curl -X POST http://localhost:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_accounts","params":{"tag":"myTag"}}' -H 'Content-Type: application/json'
{
  ...
  "result": {
    "subaddress_accounts": [{
      "account_index": 0,
      "balance": 100000,
      "base_address": "exokjHMY5Cmbjmjuw8eEeXK41sJn7JS8Wfr4Px1SwVEXLMU8Zzafmm7QmFcCbsWgcaLqT7jQ7vF2zFnBgXQGpU1V4qGEsTE9T4",
      "label": "Primary account",
      "tag": "myTag",
      "unlocked_balance": 100000
    },{
      "account_index": 1,
      "balance": 0,
      "base_address": "exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY",
...
* *height*  - unsigned int; The current exohood-wallet-rpc's blockchain height. If the wallet has been offline for a long time, it may need to catch up with the daemon.
...
* *destinations*  - array of destinations to receive exo:
...
* *unlock_time*  - unsigned int; Number of blocks before the exo can be spent (0 to not add a lock).
* *payment_id*  - string; (Optional) Random 32-byte/64-character hex string to identify a transaction.
* *get_tx_key*  - boolean; (Optional) Return the transaction key after sending.
* *do_not_relay*  - boolean; (Optional) If true, the newly created transaction will not be relayed to the exohood network. (Defaults to false)
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer","params":{"destinations":[{"amount":10000,"address":"exokjHMY5Cmbjmjuw8eEeXK41sJn7JS8Wfr4Px1SwVEXLMU8Zzafmm7QmFcCbsWgcaLqT7jQ7vF2zFnBgXQGpU1V4qGEsTE9T4"},{"amount":20000,"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY"}],"account_index":0,"subaddr_indices":[0],"priority":0,"get_tx_key": true}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"transfer_split","params":{"destinations":[{"amount":10000,"address":"exokjHMY5Cmbjmjuw8eEeXK41sJn7JS8Wfr4Px1SwVEXLMU8Zzafmm7QmFcCbsWgcaLqT7jQ7vF2zFnBgXQGpU1V4qGEsTE9T4"},{"amount":20000,"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY"}],"account_index":0,"subaddr_indices":[0],"priority":0,"get_tx_keys": true}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://localhost:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sweep_all","params":{"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","subaddr_indices":[4],"unlock_time":0,"get_tx_keys":true}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://localhost:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"sweep_single","params":{"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","unlock_time":0,"key_image":"a7834459ef795d2efb6f665d2fd758c8d9288989d8d4c712a68f8023f7804a5e","get_tx_keys":true}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"make_integrated_address","params":{"standard_address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"split_integrated_address","params":{"integrated_address": "f4VR5M6EYBQPsJvihejok8h63PadX47sgYmVttR9aCdbNeDgKWemFkzcaVHJYyZTnh8Po4UMwQmYp4HVGss7zyiQBX7DsG9xrkW27C7WndyvR"}}' -H 'Content-Type: application/json'
{
  ...
  "result": {
    "is_subaddress": false,
    "payment_id": "420fa29b2d9a49f5",
    "standard_address": "exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY"
  }
}
```
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_key","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","tx_key":"feba662cf8fb6d0d0da18fc9b70ab28e01cc76311278fdd7fe7ab16360762b06","address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","message":"this is my transaction"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","message":"this is my transaction","signature":"InProofV13vqBCT6dpSAXkypZmSEMPGVnNRFDX2vscUYeVS4WnSVnV5BwLs31T9q6Etfj9Wts6tAxSAS4gkMeSYzzLS7Gt4vvCSQRh9niGJMUDJsB5hTzb2XJiCkUzWkkcjLFBBRVD5QZ"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_tx_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","message":"wrong message","signature":"InProofV13vqBCT6dpSAXkypZmSEMPGVnNRFDX2vscUYeVS4WnSVnV5BwLs31T9q6Etfj9Wts6tAxSAS4gkMeSYzzLS7Gt4vvCSQRh9niGJMUDJsB5hTzb2XJiCkUzWkkcjLFBBRVD5QZ"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"get_spend_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","message":"this is my transaction"}}' -H 'Content-Type: application/json'
{
  ...
  "jsonrpc": "2.0",
  "result": {
    "signature": ""
  }
}
```
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_spend_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","message":"this is my transaction","signature":""}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_spend_proof","params":{"txid":"19d5089f9469db3d90aca9024dfcb17ce94b948300101c8345a5e9f7257353be","message":"wrong message","signature":""}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_reserve_proof","params":{"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","signature":""}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"check_reserve_proof","params":{"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","message":"I have 10 at least","signature":"...signature..."}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
* *in*  array of transfers:
  ...
  * *destinations*  - array of output destinations and amounts:
    * *address*  - string; the destination exohood address
  ...
  "result": {
    "transfer": {
      ...
      "destinations": [{
        ...
        "address": "exokjHMY5Cmbjmjuw8eEeXK41sJn7JS8Wfr4Px1SwVEXLMU8Zzafmmdaha6Ajda92aJKda5dada6D3AD6ddawgbtyik3Fd84GQ",
        "amount": 20000
      }],
      "double_spend_seen": false,
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"verify","params":{"data":"This is sample data to be signed","address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","signature":"SigV14K6G151gycjiGxjQ74tKX6A2LwwghvuHjcDeuRFQio5LS6Gb27BNxjYQY1dPuUvXkEbGQUkiHSVLPj4nJAHRrrw3"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"make_uri","params":{"address":"exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY","amount":10,"payment_id":"420fa29b2d9a49f5","tx_description":"Testing out the make_uri function.","recipient_name":"el00ruobuob Stagenet wallet"}}'  -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
    "uri": "exohood:exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY?tx_payment_id=420fa29b2d9a49f5&tx_amount=10.05&recipient_name=el00ruobuob%20Stagenet%20wallet&tx_description=Testing%20out%20the%20make_uri%20function."
  }
}
```
...
```
$ curl -X POST http://127.0.0.1:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"parse_uri","params":{"uri":"exohood:exoku32HZrgZBqT2D3gtMBVvyAYobaPpQP38Ju7TBq89Yz5o8TVp4NnXkVX4D5f3sLHgpD8haep9HKk69eu4sQmw8jbVUfQ1cY?tx_payment_id=420fa29b2d9a49f5&tx_amount=10.00&recipient_name=el00ruobuob%20Stagenet%20wallet&tx_description=Testing%20out%20the%20make_uri%20function."}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
```
$ curl -X POST http://localhost:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"add_address_book","params":{"address":"exok4YGjvutPsJvihejok8h63PadX47sgYmVttR9aCdbNeDgKWemFkzcaVHJYyZTnh8Po4UMwQmYp4HVGss7zyiQ3PEC7VVkc7","description":"Third account"}}' -H 'Content-Type: application/json'
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": {
...
* *received_exo*  - boolean; States if transactions to the wallet have been found in the blocks.
...
$ curl -X POST http://localhost:40000/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"make_multisig","params":{"multisig_info":["MultisigV1MTVm4DZAdJw1PyVutpSy8Q4WisZBCFRAaZY7hhQnMwr5AZ4swzThyaSiVVQM5FHj1JQi3zPKhQ4k81BZkPSEaFjwRJtbfqfJcVvCqRnmBVcWVxhnihX5s8fZWBCjKrzT3CS95spG4dzNzJSUcjheAkLzCpVmSzGtgwMhAS3Vuz9Pas24","MultisigV1TEx58ycKCd6ADCfxF8hALpcdSRAkhZTi1bu4Rs6FdRC98EdB1LY7TAkMxasM55khFgcxrSXivaSr5FCMyJGHmojm1eE4HpGWPeZKv6cgCTThRzC4u6bkkSoFQdbzWN92yn1XEjuP2XQrGHk81mG2LMeyB51MWKJAVF99Pg9mX2BpmYFj"],"threshold":2}}' -H 'Content-Type: application/json'
{
  ...
  "jsonrpc": "2.0",
  "result": {
    "address": "exok4YGjvutPsJvihejok8h63Pa1111111111111111111111111111111111111nh8Po4UMwQmYp4HVGss7zyiQ3PEC7VVkc7",
