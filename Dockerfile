...
# Create exohood user
RUN adduser --system --group --disabled-password exohood && \
	mkdir -p /wallet /home/exohood/.exohood && \
	chown -R exohood:exohood /home/exohood/.exohood && \
	chown -R exohood:exohood /wallet

# Contains the blockchain
VOLUME /home/exohood/.exohood
...
# switch to user exohood
USER exohood

ENTRYPOINT ["exohoodd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=26967", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=26968", "--non-interactive", "--confirm-external-bind"]
