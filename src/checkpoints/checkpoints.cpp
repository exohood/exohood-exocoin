...
#define exohood_DEFAULT_LOG_CATEGORY "checkpoints"
...
namespace cryptonote
{
  ...
  bool checkpoints::load_checkpoints_from_dns(network_type nettype)
  {
    ...
    // All four exohoodPulse domains have DNSSEC on and valid
    static const std::vector<std::string> dns_urls = {
      "checkpoints.exohoodpulse.com",
      "checkpoints.exohoodpulse.info",
      "checkpoints.exohoodpulse.net",
      "checkpoints.exohoodpulse.org"
    };

    static const std::vector<std::string> testnet_dns_urls = {
      "testpoints.exohoodpulse.com",
      "testpoints.exohoodpulse.info",
      "testpoints.exohoodpulse.net",
      "testpoints.exohoodpulse.org"
    };

    static const std::vector<std::string> stagenet_dns_urls = { 
      "stagenetpoints.exohoodpulse.com",
      "stagenetpoints.exohoodpulse.info",
      "stagenetpoints.exohoodpulse.net",
      "stagenetpoints.exohoodpulse.org"
    };
